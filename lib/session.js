 ...
 */
async function makeSession(authopts, authenticate = authenticate, baseUrl = 'https://accounts.pdk.io/api/') {
  let token_set;
  if (typeof authopts.refresh === 'function') token_set = authopts;else token_set = await authenticate(authopts);
