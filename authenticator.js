...
exports.authenticateclient = undefined;
...
var _clientauthenticator = require('./clientauthenticator');
...
async function authenticate({ client_id, client_secret, scope = 'openid', issuer = 'https://accounts.pdk.io', opener = _opener2.default, refresh_token }) {
...
exports.authenticateclient = _clientauthenticator.authenticateclient;
exports.default = {
  authenticate,
  authenticateclient: _clientauthenticator.authenticateclient
};